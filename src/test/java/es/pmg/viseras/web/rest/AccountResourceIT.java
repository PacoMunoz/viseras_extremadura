...
import es.pmg.viseras.config.Constants;
import es.pmg.viseras.domain.Authority;
import es.pmg.viseras.domain.User;
import es.pmg.viseras.repository.AuthorityRepository;
import es.pmg.viseras.repository.UserRepository;
import es.pmg.viseras.security.AuthoritiesConstants;
import es.pmg.viseras.service.UserService;
import es.pmg.viseras.service.dto.PasswordChangeDTO;
import es.pmg.viseras.service.dto.UserDTO;
import es.pmg.viseras.web.rest.vm.KeyAndPasswordVM;
import es.pmg.viseras.web.rest.vm.ManagedUserVM;
...
import static es.pmg.viseras.web.rest.AccountResourceIT.TEST_USER_LOGIN;
