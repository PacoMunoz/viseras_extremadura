...
import es.pmg.viseras.config.audit.AuditEventConverter;
import es.pmg.viseras.domain.PersistentAuditEvent;
import es.pmg.viseras.repository.PersistenceAuditEventRepository;
import es.pmg.viseras.security.AuthoritiesConstants;

import es.pmg.viseras.service.AuditEventService;
